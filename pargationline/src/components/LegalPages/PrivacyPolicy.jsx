  ...
  return (
    <>
      <main className="border-bottom">
        <Container className="privacyPara py-3">
          <h2>Privacy Policy</h2>
          <p>
            This privacy policy (the "PRIVACY POLICY") applies to your use of
            the website of pargationline hosted at pargationline.com , the
            Services (as defined under the Pargationline "Terms of Use") and
            Pargationline applications on mobile platforms (Android, Blackberry,
            Windows Phone, iOS etc.) (collectively ("PARGATIONLINE" or
            "WEBSITE")), but does not apply to any third party websites that may
            be linked to them, or any relationships you may have with the
            businesses listed on Pargationline.
          </p>

          <p>
            The terms "WE", "OUR" and "US" refer to Pargationline and the terms
            "YOU", "YOUR" and "USER" refer to you, as a user of Pargationline.
            The term "PERSONAL INFORMATION" means information that you provide
          ...
          <p>
            ...
            provide your third-party account credentials ("THIRD PARTY ACCOUNT
            INFORMATION") to us, you understand that some content and
          ...
          <h3>Account information of User</h3>
          <p>
            If you create an account to take advantage of the full range of
            services offered on Pargationline, we ask for and record Personal
            ...
            debit card details, bank account and know your customer ("KYC")
            documents as per RBI regulations and any other information as may be
            applicable) that the User may opt to save in the User account
            created with Pargationline. We use your email address to send you
            updates, news, and newsletters (if you willingly subscribe to the
            newsletter during signup, or anytime after signup) and contact you
            on behalf of other Users (such other Users who send you friend
            requests, personal messages, or other social collaboration based
            events). [If you do not want to receive communications from us that
            are not relevant to you or your use of our services, please click on
            the unsubscribe link provided at the bottom of such e-mails sent to
            you by us. We use your mobile numbers to send you transaction alerts
            and SMS alerts based on your preferences. If you do not wish to
            receive such SMSs from us, please notify us at
            pargationline.com/support to stop receiving SMSs from us.
            Pargationline assures that your Personal Information will not be
          ...
          <p>
            ...
            option by sending email on support@pargationline.com for erasure,
            Pargationline shall delete all stored information of the User from
            its servers.
          </p>
          <h3>Activity</h3>
          <p>
            We record information relating to your use of Pargationline, such as
            the searches you undertake, the pages you view, your browser type,
            IP address, location, requested URL, referring URL, and timestamp
            information. We use this type of information to administer
            Pargationline and provide the highest possible level of security and
            ...
            Pargationline. However, you cannot be identified from this aggregate
            information.
          </p>
          <p>
          ...
          <p>
            ...
            computer's hard drive while you are viewing the site. We may use
            both session cookies (which expire once you close your browser) and
            ...
            help file directions. If you choose to disable cookies, some areas
            of Pargationline may not work properly or at all. Pargationline uses
            third party tools, who may collect anonymous information about your
            visits to Pargationline using cookies, and interaction with
            Pargationline products and services. Such third parties may also use
            information about your visits to Pargationline products and services
            and other web sites to target advertisements for Pargationline's
            products and services. No Personal Information is collected or used
            in this process. These third parties do not know or have access to
            the name, phone number, address, email address, or any Personal
            Information about Pargationline's Users. Pargationline Users can
            opt-out of sharing this information with third parties by
          ...
          <p>
            ...
            Pargationline (including your Personal Information) in order to
          ...
          <p>
            ...
            we offer through Pargationline, conduct quality assurance testing,
          ...
          <p>
            ...
            similar governmental request that we receive.
          </p>
          <p>
          ...
          <p>
            As a registered Pargationline User, you can modify some of your
          ...
          <p>
            ...
            database. We follow industry standard best practices on Information
            Security, as also mentioned in our website. We limit the access to
            your Personal Information to those employees and contractors who
            need access to perform their job function, such as our customer
            service personnel. If you have any questions about the security on
            Pargationline, please contact us at support@pargationline.com.
          </p>
          <p>
            You hereby acknowledge that Pargationline is not responsible for any
          ...
          <p>
            ...
            Users of Pargationline. Please note that at all times you are
            responsible for updating your Personal Information, including to
            provide us with your most current e-mail address.
          </p>
          <p>
            ...
            your account with us. Continued use of Pargationline after any
          ...
          <p>
            ...
            in Delhi and Chandigarh in India and irrevocably submit themselves
            to the jurisdiction of such courts/ tribunals.
          </p>
